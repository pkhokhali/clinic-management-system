...
const menuItems = [
  ...
  { text: 'Laboratory', icon: <ScienceIcon />, path: '/dashboard/laboratory', roles: ['Super Admin', 'Admin', 'Lab Technician', 'Receptionist'] },
  { text: 'Lab Reports', icon: <AssessmentIcon />, path: '/dashboard/lab-reports', roles: ['Doctor'] },
